...
export { FeedBackIcon } from './icons/FeedBackIcon'
export { IdIcon } from './icons/IdIcon'
...
export { TpuPoint } from './icons/TpuPoint'
export { GoIcon } from './icons/GoIcon'
export { PlusIcon } from './icons/PlusIcon'
export { StarDetailIcon } from './icons/StarDetailIcon'
